                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <form id="formtarea" action="function/editarea.php" method="post">
                                                        ...
                                                        <!-- CARD MINUTO -->
                                                        <div class="card text-white bg-primary mb-3">
                                                            <div class="card-header text-white bg-primary"><strong>Minuto:</strong><button class="btn btn-light float-right ml-2" id="deselecionarminutos" name="deselecionarminutos">Desactivar todo</button><button class="btn btn-light float-right" id="selectodosminutos" name="selectodosminutos">Activar todo</button>
                                                            </div>
                                                            <div class="card-body">
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="text" id="nombretarea" name="nombretarea" class="form-control" spellcheck="false" autocapitalize="none" <?php echo 'value="' . $_SESSION['EDITARTAREA']['nombre'] . '" '; ?>required>
                                                            </div>
                                                            <div class="col-md-6">
